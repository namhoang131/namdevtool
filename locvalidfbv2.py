...
def checkvalid():
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print ("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;37m| \033[1;32mCó Liên Kết \033[1;37m| "  +  emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print ("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;37m| \033[1;31mKhông Liên Kết \033[1;37m| "  + emailfb)
...
def logo():
  logo = """
            ...
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯ 
            \033[1;31m    TOOL LỌC VALID FACEBOOK V2
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯
"""
  for pr in logo:sys.stdout.write(pr);sys.stdout.flush();time.sleep(0.001)
  choice_user = input("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;37mNhập \033[1;33m1+1 \033[1;32mLà: \033[1;33m")
  if choice_user == '2':
    clear()
    checkvalid()
  if choice_user == '3':
