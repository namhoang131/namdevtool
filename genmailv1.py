...
def checkhotmail():
  ...
  try:
    ...
    hotmail = open(input(" \033[1;37m=> Nhập File Chứa Hotmail(ex: hotmail.txt) : \033[1;33m ")).readlines()
    hotmail_die = input(f" \033[1;37m=> Nhập File Lưu Hotmail Die(hotmaildie.txt) : {vang}")
    hotmail_live = input(f" \033[1;37m=> Nhập File Lưu Hotmail Live(hotmaillive.txt) : {vang}")
  except:
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m=> |\033[1;37mNam~Tool\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m=> |\033[1;37mNam~Tool\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  try:
    print (" \033[1;34m=> CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    n_yahoo = 0
    yahoo = open(input(" \033[1;37m=> Nhập File Chứa Yahoo(ex: yahoo.txt) : \033[1;33m")).readlines()
    yahoo_die = input(f" \033[1;347=> Nhập File Lưu Yahoo Die(ex: yahoodie.txt) : {vang}")
    yahoo_live = input(f" \033[1;37m=> Nhập File Lưu Yahoo Live(ex: yahoolive.txt) : {vang}")
  except:
    print (" \033[1;31mKHÔNG TÌM THẤY FILE BẠN ĐÃ NHẬP !")
    quit()
  list_yid = []
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m=> |\033[1;37mNam~Tool\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m=> |\033[1;37mNam~Tool\033[1;31m|Email Live| " + yid + "@yahoo.com")
