...
def banner():
    banner = f"""
            ...
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯ 
            \033[1;31m               TOOL BUFF MEMBER BẰNG PROFILE
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯"""
    echo(banner)
def clear():
...
thanh()
print(ndp_tool+vang+'['+luc+'SUCCESS'+vang+']'+do+': '+trang+'UID GROUP CỦA BẠN LÀ'+vang+': ',id_gr)
thanh()
soluongrungr = int(input(ndp_tool+trang+'Bạn Muốn Tăng Bao Nhiêu Menber'+do+': '+vang))
thanh()
delay = int(input(ndp_tool+trang+'Nhập Delay Tăng Menber'+do+': '+vang))
thanh()
# RUN THAM GIA GROUP
