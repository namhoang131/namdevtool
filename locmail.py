...
def validfb():
  ...
  try:
    ...
    fileEmail = open(input(" \033[1;36mNhập File Chứa Email(ex: huynhkhoi.txt) : ")).readlines()
    valid = input(" \033[1;34mNhập File Lưu Email Valid Facebook(ex: huynhkhoi1.txt) : ")
  except:
...
def checkhotmail():
  logo="""
            ...
            \033[1;34m Facebook   : \033[1;37mhttps://facebook.com/nam.nhn131 
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯ 
            \033[1;31m    TOOL LỌC HOTMAIL LIVE/DIES
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯\n """
...
def namtool():
	logo="""
            ...
            \033[1;34m Facebook   : \033[1;37mhttps://facebook.com/nam.nhn131 
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯ 
            \033[1;31m    ARTNET CHECKER
            \033[1;36m╰─────────────────────────────────────────────────────⋟─╯\n"""
	for vc in logo:sys.stdout.write(vc);sys.stdout.flush();time.sleep(0.001)
	try:
		print("ĐỊNH DẠNG MAIL:PASS NHA MẤY HUYNH MẤY TỶ")
...
def logo():
	logo="""             
            ...
            \033[1;35m╰─────────────────────────────────────────────────────⋟─╯ 
            \033[1;37m    TOOL LỌC MAIL
            \033[1;35m╰─────────────────────────────────────────────────────⋟─╯\n"""
	clear()
	for pr in logo:sys.stdout.write(pr);sys.stdout.flush();time.sleep(0.001)
	print("\033[1;36mNẾU BẠN KHÔNG BIẾT SỬ DỤNG LỆNH VÀO TOOL HÃY DÙNG LỆNH !help")


def luachon():
	chon=input("\033[1;33mnhn\033[1;94m@\033[1;35mNamTool$ ")
	if chon == '!help':
		clear()
		help()
	if chon == '!o2pl':
